...
<div class="mt-5">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4 col-lg-4 p-2 bg-success">
                <div class="shadow-sm h-100 bg-white rounded-3 p-3">
                    ...
                    <hr class="mx-0 my-2 p-0 bg-secondary border-right-success"/>
                    <div class="row ">
                       <div class="col-12">
            ...
            <div class="col-md-4 col-lg-4 p-2 bg-info">
                <div class="shadow-sm h-100 bg-white rounded-3 p-3">
            ...
            <div class="col-md-4 col-lg-4 p-2 bg-primary">
                <div class="shadow-sm h-100 bg-white rounded-3 p-3">
